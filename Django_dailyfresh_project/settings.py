"""
Django settings for Django_dailyfresh_project project.
...
ROOT_URLCONF = 'Django_dailyfresh_project.urls'
...
WSGI_APPLICATION = 'Django_dailyfresh_project.wsgi.application'
...
EMAIL_HOST_PASSWORD = ''  # email authentication code
# EMAIL_USE_TLS = True
...
FDFS_STORAGE_URL = 'ip:port' # ip:port of fdfs server
